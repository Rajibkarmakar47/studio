      ...
      <div className="container mx-auto px-6 text-center">
        <div className="mb-12">
          ...
          <div className="flex items-center justify-center gap-6">
            <a href="#" className="w-12 h-12 rounded-xl bg-white/5 border border-primary/20 flex items-center justify-center text-primary hover:border-primary hover:bg-primary/20 transition-all group" aria-label="Discord">
            ...
            <a href="#" className="w-12 h-12 rounded-xl bg-white/5 border border-primary/20 flex items-center justify-center text-primary hover:border-primary hover:bg-primary/20 transition-all" aria-label="Instagram">
              <Instagram className="w-6 h-6" />
            </a>
            <a href="#" className="w-12 h-12 rounded-xl bg-white/5 border border-primary/20 flex items-center justify-center text-primary hover:border-primary hover:bg-primary/20 transition-all" aria-label="YouTube">
